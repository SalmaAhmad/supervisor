...
img1 = Image.open('/home/salma/ros2_ws/src/supervisor25gedid/supervisor25/ros2_ws/src/supervisor/supervisor/GUI/formulaIcon.png').resize((200, 100), Image.ANTIALIAS)
img1_tk = ImageTk.PhotoImage(img1)
imgLabel1 = Label(root, image=img1_tk, background='black')
imgLabel1.place(relx=.15, rely=0.1, anchor=CENTER)

img2 = Image.open('/home/salma/ros2_ws/src/supervisor25gedid/supervisor25/ros2_ws/src/supervisor/supervisor/GUI/racingTeamIcon.png').resize((200, 100), Image.ANTIALIAS)
...
class ROSNode(Node):
    def __init__(self):
        ...
        self.create_subscription(CanState, '/ros_can/can_state', self.canStateCallback, 10)
        self.create_subscription(String, '/missionName', self.canStateCallback, 10)
    ...
    def canStateCallback(self, msg: String):
        mission = msg.data
        self.get_logger().info("mission = " + mission)
        missionlabel.config(text=mission)   
...
missionlabel = tk.Label(root, text="not selected", font=("aptos", 11), background='black', fg='white')
