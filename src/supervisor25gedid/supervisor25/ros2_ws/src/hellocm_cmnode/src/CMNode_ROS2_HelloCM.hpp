...
#include "asurt_msgs/msg/landmark.hpp"
...
class CMNodeHelloCM : public CarMakerROSInterface {
 ...
 private:
  ...
  /**
   * @brief odometryFillMsg prepares the message of LidarRSI odometry data
   * 
   * @param msg the actual message being prepared by this function
   */
  void odometryFillMsg(nav_msgs::msg::Odometry& msg);
   ...
   * @param msg the actual message being prepared by this function
   */
  void FullLandmarkListFillMsg(asurt_msgs::msg::LandmarkArray& msg);
   ...
   * @param msg the actual message being prepared by this function
   */
  void landmarklistFillMsg(asurt_msgs::msg::LandmarkArray& msg);
